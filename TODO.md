...
- [x] Возможное мелкое улучшение: чекнуть что там с `df -T` и `stat` (лучше использовать `stat`)
...
- [ ] Допил во время ручного тестирования
    ...
    - [ ] Очистка при прерывании не только для каталогов, но для архивов
    - [ ] Исправить баг с прогресс-баром (сейчас показывет O байт, хотя процесс идет)
    - [ ] Добавить генерацию man страниц для `squash_manager-rs` через clap_mangen и build.rs

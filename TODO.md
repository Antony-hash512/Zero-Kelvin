...
- [ ] **Тестирование в ручном режиме (для человека)**
    ...
    - [ ] Если всё ок, отметить все прошлые чекбоксы данного этапа
    - [ ] Добавить чекбоксы для этапа 3.1 с расширением функционала squash_manager
        - [ ] Внедрение LUKS-шифрования
        - [ ] Реализовать truncate для сброса неиспользуемого места в конце LUKS-контейнера, используя File::set_len()
        - [ ] Внедрить перепаковку архивов вместо разботы с обычными каталога (если это ещё не реализовано)

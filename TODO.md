...
- [ ] **Интеграционные shell-тесты**
    - [x] Реализовать тесты для `mount`'а
    - [ ] Реализовать тесты для `mount`'а с автоматической генерацией имени каталога монтирования, если он не указан
    - [ ] Реализовать тесты для `umount`'а
...
- [ ] **Код на Rust**
    ...
    - [ ] Реализовать дополнительные юнит-тесты для `mount`/`umount` (если актуально)
    - [ ] Реализовать успешное прохождение всех тестов для `mount`/`umount`  
    - [ ] Обновить справочную информацию для `squash_manager-rs umount` описав новые возможности:
        - [ ] автоматическая генерация имени каталога монтирования для `mount`'а
        - [ ] указания образа вместо каталога его монтирования для `umount`'а

...
- [ ] **Cleanup и Безопасность:**
    - [ ] Не создавать freeze.sh внутри архивов, для содержимого архивов надо создавать временный каталог `payload` и создавать `freeze.sh` рядом с ним, а не внутри него.

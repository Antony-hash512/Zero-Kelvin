...
- [ ] **Новый функционал**
    - [ ] Внедрить перепаковку архивов вместо работы с обычными каталогами для форматов поверх tar'а: 7z, zip, gzip, bzip2, xz, zstd, rar + сам tar, перепаковку надо делать через пайп, без создания промежуточных файлов
        - [ ] Интеграционные shell-тесты
        - [ ] Реализация прохождения тестов
        - [ ] Обновить справочную информацию для `squash_manager-rs create` описав новые возможности

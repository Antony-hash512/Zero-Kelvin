...
давай напишем итеграционные shell-тесты для `squash_manadger-rs umount`
новая возможность:
- "скармливать" `umount`'у squashfs-образ вместо каталога монтирования и вычислять на его основе точку монтирования для передачи в реальный `umount`
Тесты для реализации:
 - размонтирование по пути к каталогу
 - размонитрование по файлу смонтированного образа

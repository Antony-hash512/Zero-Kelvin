...
Шифрование через age или gpg в потоке: Мы могли бы пропускать поток данных из mksquashfs через age прямо в rclone rcat. Это даст полную приватность, работу без root, но лишит нас возможности мгновенного монтирования архива (придется расшифровывать всё целиком перед просмотром).
